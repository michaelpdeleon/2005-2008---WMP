...
INSERT INTO xcart_languages_alt VALUES ('US','tax_1','VAT');
...
INSERT INTO xcart_tax_rates VALUES (1,1,1,'',17.500,'%','provider');
...
INSERT INTO xcart_zones VALUES (1,'UK & European Union','C26','provider');
INSERT INTO xcart_zones VALUES (2,'UK zone','C1-S134','provider');
INSERT INTO xcart_zones VALUES (4,'European Union (non-UK)','C28','provider');
...
UPDATE xcart_config SET value='N' WHERE name='disable_shipping';
...
UPDATE xcart_languages SET value='County' WHERE name='lbl_state' AND code='US';
UPDATE xcart_languages SET value='Postal code' WHERE name='lbl_zip_code' AND code='US';
UPDATE xcart_languages SET value='UK TOLL FREE' WHERE name='lbl_phone_1_title' AND code='US';
