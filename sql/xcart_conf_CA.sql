...
INSERT INTO xcart_languages_alt VALUES ('US','tax_1','GST/HST');
INSERT INTO xcart_languages_alt VALUES ('US','tax_2','PST');
...
INSERT INTO xcart_tax_rates VALUES (1,1,2,'',15.000,'%','provider');
INSERT INTO xcart_tax_rates VALUES (2,1,1,'',7.000,'%','provider');
INSERT INTO xcart_tax_rates VALUES (3,2,6,'',7.500,'%','provider');
INSERT INTO xcart_tax_rates VALUES (4,2,9,'DST+GST',10.000,'%','provider');
INSERT INTO xcart_tax_rates VALUES (5,2,3,'',0.000,'%','provider');
INSERT INTO xcart_tax_rates VALUES (6,2,4,'',6.000,'%','provider');
INSERT INTO xcart_tax_rates VALUES (7,2,5,'',7.000,'%','provider');
INSERT INTO xcart_tax_rates VALUES (8,2,8,'',8.000,'%','provider');
INSERT INTO xcart_tax_rates VALUES (9,2,7,'DST+GST',7.500,'%','provider');
...
INSERT INTO xcart_zones VALUES (1,'Canada (GST=7%)','C1-S9','provider');
INSERT INTO xcart_zones VALUES (2,'Canada (GST=15%)','C1-S3','provider');
INSERT INTO xcart_zones VALUES (3,'Canada (PST=0%)','C1-S6','provider');
INSERT INTO xcart_zones VALUES (4,'Canada (PST=6%)','C1-S1','provider');
INSERT INTO xcart_zones VALUES (5,'Canada (PST=7%)','C1-S1','provider');
INSERT INTO xcart_zones VALUES (6,'Canada (British Columbia, PST=7.5%)','C1-S1','provider');
INSERT INTO xcart_zones VALUES (7,'Canada (Quebec, PST=7.5%)','C1-S1','provider');
INSERT INTO xcart_zones VALUES (8,'Canada (PST=8%)','C1-S1','provider');
INSERT INTO xcart_zones VALUES (9,'Canada (Prince Edward Island, PST=10%)','C1-S1','provider');
...
INSERT INTO xcart_zone_element VALUES (6,'CA','C');
INSERT INTO xcart_zone_element VALUES (6,'CA_BC','S');
...
UPDATE xcart_languages SET value='Province/Territory' WHERE name='lbl_state' AND code='US';
UPDATE xcart_languages SET value='Postal code' WHERE name='lbl_zip_code' AND code='US';
UPDATE xcart_languages SET value='CANADA TOLL FREE' WHERE name='lbl_phone_1_title' AND code='US';
