...
REPLACE INTO xcart_languages_alt VALUES ('US','tax_1','GST');





INSERT INTO xcart_tax_rates VALUES (1,1,1,'',10.000,'%','provider');





INSERT INTO xcart_zones VALUES (1,'Australia','C1-S8','provider');
INSERT INTO xcart_zones VALUES (2,'New Zealand','C1','provider');
...
UPDATE xcart_languages SET value='AUSTRALIA TOLL FREE' WHERE name='lbl_phone_1_title' AND code='US';
...
REPLACE INTO xcart_languages VALUES ('US','lbl_zipcode_masks','Postal code masks','Labels');
REPLACE INTO xcart_languages VALUES ('US','lbl_zipcode_mask_examples','Postal code mask examples','Text');
REPLACE INTO xcart_languages VALUES ('US','lbl_zip_code','Postal code','Labels');
REPLACE INTO xcart_languages VALUES ('US','lbl_zip_postal_codes','Postal codes','Labels');
REPLACE INTO xcart_languages VALUES ('US','lbl_origin_zip_code','Origin postal code','Labels');
REPLACE INTO xcart_languages VALUES ('US','opt_default_zipcode','Default postal code','Options');
REPLACE INTO xcart_languages VALUES ('US','opt_location_zipcode','Company postal code','Options');

UPDATE xcart_languages SET value='Federal State' WHERE name='lbl_state' AND code='US';
UPDATE xcart_languages SET value='Federal States Management' WHERE name='lbl_states_management' AND code='US';
UPDATE xcart_languages SET value='Federal States' WHERE name='lbl_states' AND code='US';
