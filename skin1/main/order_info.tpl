{* $Id: order_info.tpl,v 1.37.2.1 2006/07/20 06:39:07 max Exp $ *}
...
<tr> 
	...
	<td valign="top">{$order.shipping|trademark}{if $order.extra.shipping_warning ne ''}<br /><font class="ErrorMessage">{$order.extra.shipping_warning}</font>{/if}</td>
</tr>
