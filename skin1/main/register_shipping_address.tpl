...
-->
	...
	<!-- Start addition by Michael de Leon 02.16.07 -->
		<td><input type="checkbox" id="ship2diff" name="ship2diff" value="Y" onclick="javascript: ship2diffOpen();"{if $ship2diff} checked="checked"{/if} /></td>
		<td>&nbsp;</td>
		<td><label for="ship2diff" class="wwmp_yourinfo_label">{$lng.lbl_ship_to_different_address}</label></td>
	<!-- End addition by Michael de Leon 02.16.07 -->
...
<tbody id="ship_box"{if !$ship2diff} style="display: none;"{/if}>
...
<td align="left">{if $default_fields.s_firstname.required eq 'Y'}<font class="Star">*</font>{else}&nbsp;{/if}</td>
<td align="left"> 
...
<td align="left">{if $default_fields.s_lastname.required eq 'Y'}<font class="Star">*</font>{else}&nbsp;{/if}</td>
<td align="left">
...
<td align="left">{if $default_fields.s_address.required eq 'Y'}<font class="Star">*</font>{else}&nbsp;{/if}</td>
<td align="left">
...
<td align="left">{if $default_fields.s_address_2.required eq 'Y'}<font class="Star">*</font>{else}&nbsp;{/if}</td>
<td align="left">
...
<td align="left">{if $default_fields.s_city.required eq 'Y'}<font class="Star">*</font>{else}&nbsp;{/if}</td>
<td align="left">
...
<td align="left">{if $default_fields.s_county.required eq 'Y'}<font class="Star">*</font>{else}&nbsp;{/if}</td>
<td align="left">
...
<td align="left">{if $default_fields.s_state.required eq 'Y'}<font class="Star">*</font>{else}&nbsp;{/if}</td>
<td align="left">
...
<td align="left">{if $default_fields.s_zipcode.required eq 'Y'}<font class="Star">*</font>{else}&nbsp;{/if}</td>
<td align="left">
...
<td align="left">{if $default_fields.s_country.required eq 'Y'}<font class="Star">*</font>{else}&nbsp;{/if}</td>
<td align="left">
