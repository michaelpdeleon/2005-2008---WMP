{* $Id: general.tpl,v 1.54.2.1 2006/06/16 10:47:40 max Exp $ *}
...
<tr>
<td colspan="2"><a name="License" />{include file="main/subheader.tpl" title=$lng.lbl_license_info}</td>
</tr>
...
<tr>
<td colspan="2"><a name="General" />{include file="main/subheader.tpl" title=$lng.lbl_general_info}</td>
</tr>
...
<tr>
<td colspan="2"><a name="PaymentMethods" />{include file="main/subheader.tpl" title=$lng.lbl_payments_methods_info}</td>
</tr>
...
<tr>
<td colspan="2"><a name="Environment" />{include file="main/subheader.tpl" title=$lng.lbl_environment_info}</td>
</tr>
