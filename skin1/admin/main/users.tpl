{* $Id: users.tpl,v 1.76.2.3 2006/07/11 08:39:27 svowl Exp $ *}
...
searchform_def[8] = new Array('StartDay', '{$search_prefilled.start_date|default:$smarty.now|date_format:"%d"}');
searchform_def[9] = new Array('StartMonth', '{$search_prefilled.start_date|default:$smarty.now|date_format:"%m"}');
searchform_def[10] = new Array('StartYear', '{$search_prefilled.start_date|default:$smarty.now|date_format:"%Y"}');
searchform_def[11] = new Array('EndDay', '{$search_prefilled.end_date|default:$smarty.now|date_format:"%d"}');
searchform_def[12] = new Array('EndMonth', '{$search_prefilled.end_date|default:$smarty.now|date_format:"%m"}');
searchform_def[13] = new Array('EndYear', '{$search_prefilled.end_date|default:$smarty.now|date_format:"%Y"}');
-->
</script>
