{* $Id: categories.tpl,v 1.43.2.2 2006/07/11 08:39:26 svowl Exp $ *}
...
<tr{cycle values=', class="TableSubHead"'}>
	...
	<td align="center"><a href="category_products.php?cat={$catid}">{$c.product_count|default:$lng.txt_not_available}</a></td>
