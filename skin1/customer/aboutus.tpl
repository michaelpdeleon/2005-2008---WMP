...
-->
<body {$reading_direction_tag}{if $body_onload ne '' or $smarty.get.mode eq "order_message"} onload="{if $smarty.get.mode eq "order_message"}javascript:__utmSetTrans();{/if} load(); {$body_onload}"{else} onload="Defaults(); load();"{/if} onunload="GUnload()">
...
{include file="customer/aboutus_main.tpl"}
<!-- /central space -->
&nbsp;
		</td>
