...
var Special_Days = []
Special_Days[0]=['March','5','2006','stm(Text[0],Style[0])','javascript:void(0);']
Special_Days[1]=['March','6','2006','stm(Text[0],Style[0])','javascript:void(0);']
Special_Days[2]=['March','7','2006','stm(Text[0],Style[0])','javascript:void(0);']
Special_Days[3]=['July','15','2006','stm(Text[1],Style[0])','javascript:void(0);']
Special_Days[4]=['July','16','2006','stm(Text[1],Style[0])','javascript:void(0);']
Special_Days[5]=['September','20','2006','stm(Text[2],Style[0])','javascript:void(0);']
Special_Days[6]=['September','21','2006','stm(Text[2],Style[0])','javascript:void(0);']
Special_Days[7]=['June','24','2006','stm(Text[3],Style[0])','javascript:void(0);']
Special_Days[8]=['May','17','2007','stm(Text[4],Style[0])','javascript:void(0);']
Special_Days[9]=['June','20','2007','stm(Text[5],Style[0])','javascript:void(0);']
...
Text[0]=["&nbsp;International Restaurant & Food Service","March 5-7, 2006<br />New York, NY<br />Food Science Industry"]
Text[1]=["&nbsp;ACF 2006 National Convention","July 15-16, 2006<br />Philadelphia, PA<br />Food Science Industry"]
Text[2]=["&nbsp;Mid-Atlantic Food, Beverage & Lodging","September 20-21, 2006<br />Baltimore, MD<br />Food Science Industry"]
Text[3]=["&nbsp;Warehouse Sale","June 24, 2006<br />8:30 AM - 2:00 PM<br /><br />WorldWide Medical Products, Inc.<br />2521 Kuser Road<br />Hamilton, NJ 08691"]
Text[4]=["&nbsp;LRIG","May 17, 2007<br />3:00 PM - 9:00 PM<br /><br />Hilton East Brunswick<br />Three Tower Center Boulevard<br />East Brunswick, NJ 08816"]
Text[5]=["&nbsp;Intramall Summer Showcase","June 20, 2007<br />NIH Campus<br />Bethesda, MD"]
