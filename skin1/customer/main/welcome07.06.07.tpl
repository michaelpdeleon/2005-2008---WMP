...
<embed src="{$ImagesDir}/bioexcell_flash_intro.swf" menu="false" quality="high" bgcolor="#ffffff" wmode="transparent" width="632" height="160" name="bioexcell_flash_intro" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
  ...
  <tr>
  	<td width="635" height="357" background="{$ImagesDir}/wwmp_mission10.25.06.jpg" align="left" class="welcome_box3"><br /><font class="wwmp_mission_title">WorldWide Medical Products, Inc.</font><br />
	  ...
	  <p class="wwmp_mission_p1"><strong>WorldWide Medical Products, Inc. (WWMP)</strong> - a technologically advanced, quality-driven provider of essential laboratory wares and services to the scientific community, is dedicated to exceeding the wants and needs of our clients. Our mission is to utilize our unique comprehension and understanding of the research and development market, while maintaining the ability to respond and adapt to our clients needs. The personal attention and custom-tailored solutions our clients deserve are ultimately achieved through the collaboration of our team of technical and professional consultative representatives.</p>
  	  <p class="wwmp_mission_p2">Our <strong><em>Bio</em>Excell</strong>&trade; high Fidelity Research Products are the core of WWMP&rsquo;s laboratory supply division. The <strong><em>Bio</em>Excell</strong>&trade; brand is the culmination of WWMP&rsquo;s years of experience and expertise, which has deemed these products to be the essential tools needed for every lab to succeed. <strong><em>Bio</em>Excell</strong>&trade; products represent the broad spectrum of laboratory supplies that fit the needs of today&rsquo;s cutting edge research. These premium grade products are subjected to stringent testing and feature precise tolerances so that you may rest assured you are getting the highest quality product available.</p>
  	  <p class="wwmp_mission_p3">Our customer service team is dedicated to bring individual attention, prompt delivery and competitive pricing to suit every client&rsquo;s needs. We are driven to uncover each client&rsquo;s unique profile and strive to maintain the flexibility to respond quickly to the requirements of your ever-evolving business. Our philosophy is to &ldquo;meet and exceed&rdquo; every client&rsquo;s expectations.</p>
  	  </td>
  </tr>
<!--
  <tr>
	...
	<img src="{* $ImagesDir *}/wwmp_whatsnew1_10.27.06.jpg"><img class="wwmp_whatsnewpics" src="{* $ImagesDir *}/wwmp_whatsnew2_10.27.06.jpg"><img src="{* $ImagesDir *}/wwmp_whatsnew3_10.27.06.jpg">
	</td>
  </tr>
-->
</table>
