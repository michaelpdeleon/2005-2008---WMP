...
<embed src="{$ImagesDir}/bioexcell_flash_intro.swf" menu="false" quality="high" bgcolor="#ffffff" wmode="transparent" width="632" height="160" name="bioexcell_flash_intro" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
  ...
  <tr>
	...
	-->
		<a href="http://www.wwmponline.com/cart/eurogentec-m-9.html"><img src="{ $ImagesDir }/wwmp_whatsnew_eurogentech03.22.07.jpg" border="0"></a><a href="http://www.wwmponline.com/cart/bioexcell-nitrile-glove-powder-free-c-41-p-1-pr-4.html"><img src="{ $ImagesDir }/wwmp_whatsnew_nitrilegloves10.11.07.jpg" border="0" class="wwmp_whatsnewpics"></a><a href="http://www.wwmponline.com/cart/tecan-96-tip-format-c-58.html"><img src="{ $ImagesDir }/wwmp_whatsnew_tecantips03.22.07.jpg" border="0"></a> </td>
  </tr>
  <tr>
	...
	<!--
		<img class="wwmp_whatsnewtitle" src="{* $ImagesDir *}/wwmp_whatsnew_title10.27.06.jpg"><br>
	-->
		<a href="http://www.wwmponline.com/cart/tpp-m-12.html"><img src="{ $ImagesDir }/wwmp_whatsnew_tpp03.22.07.jpg" border="0"></a><a href="http://www.wwmponline.com/cart/17ml-surseal-microcentrifuge-tubes-pr-79.html"><img src="{ $ImagesDir }/wwmp_whatsnew_1.7mlTubes10.11.07.jpg" border="0" class="wwmp_whatsnewpics"></a><a href="http://www.wwmponline.com/cart/bioexcell-ultimate-reload-system-c-52-p-2-pr-58.html"><img src="{ $ImagesDir }/wwmp_whatsnew_utimateReload03.22.07.jpg" border="0"></a> </td>
  </tr>
  <!--
  <tr>
