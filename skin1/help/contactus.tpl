...
<img class="wwmp_catalog_banner" src="{$ImagesDir}/wwmp_contactus_banner.jpg">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="wwmp_contactus_labels" align="left" colspan="2"><font class="wwmp_contactus_labels">{$lng.lbl_contact_us}</font> <font class="wwmp_yourinfo_required">(<font class="wwmp_yourinfo_star">*</font> <strong>required</strong>)</font></td>
	</tr>
	<tr>
		<td class="wwmp_contactus_textmain" align="left" colspan="2">Fill out the form below to send us a message or contact us using any of the following methods.</td>
	</tr>
	<tr>
		<td class="wwmp_contactus_text" align="left" valign="top"><strong>U.S. Toll-free:</strong> (866) 889-WWMP (9967)</td>
		<td class="wwmp_contactus_text" align="left" valign="top"><strong>Mailing Address:</strong></td>
	</tr>
	<tr>
		<td class="wwmp_contactus_text" align="left" valign="top"><strong>International:</strong> (609) 570-1100</td>
		<td class="wwmp_contactus_text" align="left" valign="top"><strong>WorldWide Medical Products, Inc.</strong></td>
	</tr>
	<tr>
		<td class="wwmp_contactus_text" align="left" valign="top"><strong>Fax:</strong> (609) 570-1110</td>
		<td class="wwmp_contactus_text" align="left" valign="top">2521 Kuser Road</td>
	</tr>
	<tr>
		<td class="wwmp_contactus_text" align="left" valign="top"><strong>Email:</strong> <a class="wwmp_contactus_textlink" href="mailto:sales@wwmponline.com">sales@wwmponline.com</a></td>
		<td class="wwmp_contactus_text" align="left" valign="top">Hamilton, New Jersey 08691</td>
	</tr>
	<tr>
		<td class="wwmp_contactus_text" align="left" valign="top">&nbsp;</td>
		<td class="wwmp_contactus_text" align="left" valign="top">United States</td>
	</tr>
</table>
</div>
{if $smarty.get.mode eq "update"}
...
<td align="left">{if $default_fields.firstname.required eq 'Y'}<font class="Star">*</font>{/if}</td>
<td align="left">
...
<td align="left">{if $default_fields.lastname.required eq 'Y'}<font class="Star">*</font>{else}&nbsp;{/if}</td>
<td align="left">
...
<tr>
<td class="wwmp_yourinfo_label" align="right">{$lng.lbl_company}</td>
<td align="left">{if $default_fields.company.required eq 'Y'}<font class="Star">*</font>{else}&nbsp;{/if}</td>
<td align="left">
...
<td align="left">{if $default_fields.email.required eq 'Y'}<font class="Star">*</font>{/if}</td>
<td align="left">
...
<tr>
<td class="wwmp_yourinfo_label" align="right">{$lng.lbl_subject}</td>
...
<tr>
<td class="wwmp_yourinfo_label" align="right">{$lng.lbl_message}</td>
<td align="left"><font class="Star">*</font></td>
<td align="left">
...
-->
<a href="javascript: if (checkEmailAddress(document.registerform.email) && checkRequired(requiredFields) && check_zip_code(document.getElementById('b_country'), document.getElementById('b_zipcode'))) document.registerform.submit()"><img src="{$ImagesDir}/wwmp_sendbtn11.29.06.jpg" border="0"></a>
{else}
...
<table border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td class="wwmp_contactus_status" align="left">{$lng.txt_contact_us_sent}</td>
	</tr>
</table>
</div>
{/if}
