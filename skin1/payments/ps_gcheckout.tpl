{* $Id: ps_gcheckout.tpl,v 1.1.2.1 2006/07/29 07:27:44 max Exp $ *}
...
<tr>
<td>{$lng.lbl_cc_gcheckout_mid}:</td>
<td><input type="text" name="param01" size="15" maxlength="15" value="{$module_data.param01|escape}" /></td>
</tr>

<tr>
<td>{$lng.lbl_cc_gcheckout_mkey}:</td>
<td><input type="text" name="param02" size="22" maxlength="22" value="{$module_data.param02|escape}" /></td>
</tr>
...
<td><input type="text" name="param05" size="36" value="{$module_data.param04|escape}" /></td>
</tr>
</table>
