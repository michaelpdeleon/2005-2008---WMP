...
<th bgcolor="#cccccc" align="center">
	{$products[0].extra_fields[0].field}
</th>
{/if}
...
{if $active_modules.Extra_Fields ne ""}
<TD align="center">
	{if $product.extra_field1 && $product.extra_field1 ne ""}
		{$product.extra_field1}
	{else}
...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
<tr>
	<td align="right"><font style="FONT-SIZE: 14px; FONT-WEIGHT: bold;">{$lng.lbl_applied_giftcerts}</font></td>
</tr>
</table>
