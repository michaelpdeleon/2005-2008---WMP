...
function check_options() {
	...
	if (variantid) {
		...
		discount_price = variants[variantid][0][7] ;
...
/* Start addition by Michael Gunin, X-Cart Technician 09.28.06 */
		/* Change Ships in field */
		if (document.getElementById('product_extrafield1'))
			document.getElementById('product_extrafield1').innerHTML = variants[variantid][0][6];
/* End addition by Michael Gunin, X-Cart Technician 09.28.06 */
	}
    ...
    if (document.getElementById('product_discount_price'))
	        document.getElementById('product_discount_price').innerHTML = currency_symbol+price_format(discount_price < 0 ? 0 : discount_price);
