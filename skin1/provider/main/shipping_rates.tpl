{* $Id: shipping_rates.tpl,v 1.46.2.2 2006/07/11 08:39:37 svowl Exp $ *}
...
<tr>
	...
	<td><b><label for="sm_{$zones_list[zone].zone.zoneid}_{$shipid}">{$shipping_method.shipping} ({if $shipping_method.destination eq "I"}{$lng.lbl_intl}{else}{$lng.lbl_national}{/if})</label></b></td>
</tr>
</table>
