{* $Id: tax_rates.tpl,v 1.11.2.2 2006/07/11 08:39:37 svowl Exp $ *}
...
<input type="text" size="20" maxlength="13" name="posted_data[{$tax_rates[tax].rateid}][rate_value]" value="{$tax_rates[tax].rate_value|formatprice}" />
