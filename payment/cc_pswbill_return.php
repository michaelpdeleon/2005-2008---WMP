...
#
# $Id: cc_pswbill_return.php,v 1.12 2006/01/11 06:56:22 mclap Exp $
#

if (!isset($REQUEST_METHOD))
	$REQUEST_METHOD = $HTTP_SERVER_VARS["REQUEST_METHOD"];

if($REQUEST_METHOD=="GET" && $HTTP_GET_VARS["User1"] && $HTTP_GET_VARS["IPAddress"] && $HTTP_GET_VARS["TransactionID"])
{
	require "./auth.php";
