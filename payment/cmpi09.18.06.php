...
#
# $Id: cmpi.php,v 1.26.2.1 2006/06/01 07:19:30 max Exp $
#
...
<tr>
    <td valign="top" align="center"><iframe width="410" height="410" scrolling="no" marginwidth="0" marginheight="0" src="<?php echo $current_location."/payment/cmpi.php?".$XCART_SESSION_NAME."=".$XCARTSESSID."&iframe"; ?>" ></iframe></td>
</tr>
</table>
<?php
		exit;
...
#
	...
	# Redirect to ...
	echo "<script> window.parent.location='".$current_location."/payment/cmpi.php?".$XCART_SESSION_NAME."=".$XCARTSESSID."&close_frame';</script>";
	exit;
}
?>
