...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'main/states.tpl', 3, false),)), $this); ?>
...
"<?php if ($this->_tpl_vars['default'] == $this->_tpl_vars['states'][$this->_sections['state_idx']['index']]['state_code'] && $this->_tpl_vars['default_country'] == $this->_tpl_vars['states'][$this->_sections['state_idx']['index']]['country_code']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['states'][$this->_sections['state_idx']['index']]['country_code']; ?>
: <?php echo $this->_tpl_vars['states'][$this->_sections['state_idx']['index']]['state']; ?>
</option>
