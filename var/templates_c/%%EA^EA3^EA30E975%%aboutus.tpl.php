<?php /* Smarty version 2.6.12, created on 2014-10-11 21:15:03
         compiled from customer/aboutus.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'customer/aboutus.tpl', 6, false),array('modifier', 'strip_tags', 'customer/aboutus.tpl', 12, false),array('modifier', 'escape', 'customer/aboutus.tpl', 12, false),)), $this); ?>
<?php func_load_lang($this, "customer/aboutus.tpl","lbl_events_calendar"); ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
var Special_Days = []
Special_Days[0]=[\'May\',\'17\',\'2007\',\'stm(Text[0],Style[0])\',\'javascript:void(0);\']
Special_Days[1]=[\'June\',\'20\',\'2007\',\'stm(Text[1],Style[0])\',\'javascript:void(0);\']
Special_Days[2]=[\'July\',\'15\',\'2007\',\'stm(Text[2],Style[0])\',\'javascript:void(0);\']
Special_Days[3]=[\'July\',\'16\',\'2007\',\'stm(Text[2],Style[0])\',\'javascript:void(0);\']
Special_Days[4]=[\'July\',\'17\',\'2007\',\'stm(Text[2],Style[0])\',\'javascript:void(0);\']
Special_Days[5]=[\'July\',\'18\',\'2007\',\'stm(Text[2],Style[0])\',\'javascript:void(0);\']
Special_Days[6]=[\'July\',\'19\',\'2007\',\'stm(Text[2],Style[0])\',\'javascript:void(0);\']
...
<!-- Start of addition by Michael de Leon 12.18.06 -->
<?php echo '
<script src="http://maps.google.com/maps?file=api&amp;v=2&amp;key=ABQIAAAAh109UrMslgh_GVDyzCjtmRRccH2JdxIQCwvBind89SvelnwGsRSMTptg3RvljUUry3QICjCvs9k24w"
    ...
    function load() {
      if (GBrowserIsCompatible()) {
        ...
        map.setCenter(new GLatLng(40.204837, -74.65785), 7);
		
		// Creates a marker at the given point with the given number label
		function createMarker(point, number) {
  			var marker = new GMarker(point);
  			GEvent.addListener(marker, "click", function() {
	    	marker.openInfoWindowHtml("<div style=\'width:50px\'><br><br><strong><a class=\'wwmp_vertmenulink\' href=\'http://www.google.com/maps?f=q&hl=en&q=2521+Kuser+Rd+Hamilton,+NJ&ie=UTF8&z=15&ll=40.204837,-74.65785&spn=0.021403,0.044932&om=1&iwloc=addr\' target=\'_self\'>Zoom in</a></strong></div>");});
			return marker;
		}
	
		var point = new GLatLng(40.204837, -74.65785);
...
<!-- End of addition by Michael de Leon 12.18.06 -->
</head>
<!-- Start of edit by Michael de Leon 09.14.06 -->
<!-- Deleted by Michael de Leon 12.18.06
<body onload="javascript: " onload="Defaults();">
-->
<body <?php echo $this->_tpl_vars['reading_direction_tag'];  if ($this->_tpl_vars['body_onload'] != '' || $GLOBALS['HTTP_GET_VARS']['mode'] == 'order_message'): ?> onload="<?php if ($GLOBALS['HTTP_GET_VARS']['mode'] == 'order_message'): ?>javascript:__utmSetTrans();<?php endif; ?> load(); <?php echo $this->_tpl_vars['body_onload']; ?>
"<?php else: ?> onload="Defaults(); load();"<?php endif; ?> onunload="GUnload()">
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "customer/aboutus_main.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<!-- /central space -->
...
Style[0]=["#ffffff","#3366cc","","","",1,"#000000","#fff9d4","","","",1,250,,1,"#000000",3,24,0.5,,2,"#666666",,,-3,25]
Text[0]=["&nbsp;LRIG","May 17, 2007<br />3:00 PM - 9:00 PM<br /><br />Hilton East Brunswick<br />Three Tower Center Boulevard<br />East Brunswick, NJ 08816"]
Text[1]=["&nbsp;Intramall Summer Showcase","June 20, 2007<br />NIH Campus<br />Bethesda, MD"]
Text[2]=["&nbsp;AACC (American Association for<br />&nbsp;Clinical Chemistry) Annual Meeting and<br />&nbsp;Clinical Lab Expo","July 15-19, 2007<br />San Diego, CA"]
